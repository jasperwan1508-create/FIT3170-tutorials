import type { bool, double, InputArray, InputArrayOfArrays, InputOutputArray, InputOutputArrayOfArrays, int, Mat, MinMaxLoc, OutputArray, OutputArrayOfArrays, Scalar, size_t } from "@techstark/opencv-js/dist/src/types/opencv/_types";
/**
