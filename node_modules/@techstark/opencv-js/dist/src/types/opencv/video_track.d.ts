import type { bool, double, InputArray, InputOutputArray, int, Mat, OutputArray, OutputArrayOfArrays, RotatedRect, Size, TermCriteria } from "@techstark/opencv-js/dist/src/types/opencv/_types";
/**
