import type { bool, double, InputArray, InputArrayOfArrays, int, Mat, Net, OutputArray, OutputArrayOfArrays, Size, size_t, uchar } from "@techstark/opencv-js/dist/src/types/opencv/_types";
/**
