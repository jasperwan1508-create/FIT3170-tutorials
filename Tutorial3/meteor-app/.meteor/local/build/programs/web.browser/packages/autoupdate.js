...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                              //
module.export({Autoupdate:()=>Autoupdate},true);let ClientVersions;module.link("./client_versions.js",{ClientVersions(v){ClientVersions=v}},0);// Subscribe to the `meteor_autoupdate_clientVersions` collection,
...
const clientVersions = Autoupdate._clientVersions = new ClientVersions();
Meteor.connection.registerStoreClient("meteor_autoupdate_clientVersions", clientVersions.createStore());
Autoupdate.newClientAvailable = function() {
    return clientVersions.newClientAvailable(clientArch, [
        "versionRefreshable",
